...
replace github.com/fluxcd/helm-controller => ./upstream

// Requirement from upstream.
replace github.com/opencontainers/go-digest => github.com/opencontainers/go-digest v1.0.1-0.20220411205349-bde1400a84be

require (
	github.com/fluxcd/helm-controller v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/opencontainers/go-digest/blake3 v0.0.0-20230815154656-802ce17c4f59 // indirect
